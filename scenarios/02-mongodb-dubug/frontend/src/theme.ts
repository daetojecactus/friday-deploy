...
// Палитра стенда: та же темная схема дежурной консоли, что была на прошлой
// версии страницы, только выражена токенами antd.
...
export const standTheme: ThemeConfig = {
  ...
  components: {
    Layout: { headerBg: STAND_COLORS.card, bodyBg: STAND_COLORS.bg, headerHeight: 'auto' as never },
    ...
    Table: { headerBg: '#1c202a', cellPaddingBlockSM: 7 },
    Alert: { fontSize: 13 },
  },
};
