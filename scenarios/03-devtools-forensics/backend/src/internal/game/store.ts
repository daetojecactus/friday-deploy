...
// Паузы между репликами. Нужны только чтобы реплики не падали в ленту одной
// пачкой и было видно «кто печатает»: одного тика опроса достаточно. Дольше
// держать нельзя — ведущий ждёт ответа ИБ вместо того, чтобы вести урок.
const DELAY = {
  danger: 1200,
  hintAnswer: 1000,
  milestone: 900,
